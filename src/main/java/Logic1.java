...
public class Logic1
{
    ...
    public boolean nearTen(int num) {
         boolean trueOrFalse=false;
        if(num>=0){
          if(num%10<=2 || (num+2)%10==0 || (num+1)%10==0) {
              trueOrFalse= true;
          }
        }
      return trueOrFalse;
    ...
    public boolean answerCell(boolean isMorning, boolean isMom, boolean isAsleep) {
      ...
      else if(isAsleep==true || (isMorning==true && isMom==false)){
          answer=false;
      }
      else{
          answer=true;
    ...
    public int dateFashion(int you, int date) {
      ...
      else if(you<8 && you>=5 && date<8 && date>=5){
          result=1;
      }
